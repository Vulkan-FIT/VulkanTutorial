...
struct ExtensionDbRecord {
	uint32_t number;
	const char name[];
};
static constexpr const ExtensionDbRecord VK_KHR_surface_extensionRecord          (1, "VK_KHR_surface");
static constexpr const ExtensionDbRecord VK_KHR_swapchain_extensionRecord        (2, "VK_KHR_swapchain");
static constexpr const ExtensionDbRecord VK_KHR_display_extensionRecord          (3, "VK_KHR_display");
static constexpr const ExtensionDbRecord VK_KHR_display_swapchain_extensionRecord(4, "VK_KHR_display_swapchain");
static constexpr const ExtensionDbRecord VK_KHR_xlib_surface_extensionRecord     (5, "VK_KHR_xlib_surface");
static constexpr const ExtensionDbRecord VK_KHR_xcb_surface_extensionRecord      (6, "VK_KHR_xcb_surface");
static constexpr const ExtensionDbRecord VK_KHR_wayland_surface_extensionRecord  (7, "VK_KHR_wayland_surface");
static constexpr const ExtensionDbRecord VK_KHR_mir_surface_extensionRecord      (8, "VK_KHR_mir_surface");
static constexpr const ExtensionDbRecord VK_KHR_android_surface_extensionRecord  (9, "VK_KHR_android_surface");
static constexpr const ExtensionDbRecord VK_KHR_win32_surface_extensionRecord    (10, "VK_KHR_win32_surface");
static constexpr const ExtensionDbRecord VK_ANDROID_native_buffer_extensionRecord(11, "VK_ANDROID_native_buffer");
static constexpr const ExtensionDbRecord VK_EXT_debug_report_extensionRecord     (12, "VK_EXT_debug_report");
static constexpr const ExtensionDbRecord VK_NV_glsl_shader_extensionRecord       (13, "VK_NV_glsl_shader");
static constexpr const ExtensionDbRecord VK_EXT_depth_range_unrestricted_extensionRecord(14, "VK_EXT_depth_range_unrestricted");
static constexpr const ExtensionDbRecord VK_KHR_sampler_mirror_clamp_to_edge_extensionRecord(15, "VK_KHR_sampler_mirror_clamp_to_edge");
static constexpr const ExtensionDbRecord VK_IMG_filter_cubic_extensionRecord     (16, "VK_IMG_filter_cubic");
static constexpr const ExtensionDbRecord VK_AMD_rasterization_order_extensionRecord(19, "VK_AMD_rasterization_order");
static constexpr const ExtensionDbRecord VK_AMD_shader_trinary_minmax_extensionRecord(21, "VK_AMD_shader_trinary_minmax");
static constexpr const ExtensionDbRecord VK_AMD_shader_explicit_vertex_parameter_extensionRecord(22, "VK_AMD_shader_explicit_vertex_parameter");
static constexpr const ExtensionDbRecord VK_EXT_debug_marker_extensionRecord     (23, "VK_EXT_debug_marker");
static constexpr const ExtensionDbRecord VK_KHR_video_queue_extensionRecord      (24, "VK_KHR_video_queue");
static const set<string_view> extensionDB{
	VK_KHR_surface_extensionRecord.name,
	VK_KHR_swapchain_extensionRecord.name,
	VK_KHR_display_extensionRecord.name,
	VK_KHR_display_swapchain_extensionRecord.name,
	VK_KHR_xlib_surface_extensionRecord.name,
	VK_KHR_xcb_surface_extensionRecord.name,
	VK_KHR_wayland_surface_extensionRecord.name,
	VK_KHR_mir_surface_extensionRecord.name,
	VK_KHR_android_surface_extensionRecord.name,
	VK_KHR_win32_surface_extensionRecord.name,
	VK_ANDROID_native_buffer_extensionRecord.name,
	VK_EXT_debug_report_extensionRecord.name,
	VK_NV_glsl_shader_extensionRecord.name,
	VK_EXT_depth_range_unrestricted_extensionRecord.name,
	VK_KHR_sampler_mirror_clamp_to_edge_extensionRecord.name,
	VK_IMG_filter_cubic_extensionRecord.name,
	VK_AMD_rasterization_order_extensionRecord.name,
	VK_AMD_shader_trinary_minmax_extensionRecord.name,
	VK_AMD_shader_explicit_vertex_parameter_extensionRecord.name,
	VK_EXT_debug_marker_extensionRecord.name,
	VK_KHR_video_queue_extensionRecord.name,
};

static uint32_t extensionNameToNumber(const char* name) {
	auto it = extensionDB.find(name);
	if(it == extensionDB.end())
		return 0;

	const char* s = it->data();
	return *reinterpret_cast<const uint32_t*>(s - 4);
}


ExtensionSet::ExtensionSet(const Vector<ExtensionProperties>& extensionList)
{
	clear();
}


void ExtensionSet::append(const Vector<ExtensionProperties>& extensionList)
{
}
